  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        console.log('Loading CSV file from backend API...');
        
        // Load CSV file from backend API
        const response = await fetch(`http://localhost:4000/api/phase2-file?name=${selectedFile}`);
